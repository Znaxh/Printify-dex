...
export default function HowItWorks() {
  return (
    ...
    <section className=" bg-[#f7f7f7] relative">
      ...
      <Container className="pt-10 sm:pt-[280px]  xl:pb-10">
        <motion.div viewport={{ once: true }} whileInView={{width: '100%', opacity:1}} initial={{width:"0%", opacity:0}} transition={{duration:0.5, delay:0.3, ease:"easeInOut"}} className="flex flex-col lg:flex-row justify-end bg-white rounded-xl lg:pt-10 pb-12 sm:pb-32 lg:pr-10 relative">
          <div className="lg:absolute bottom-5 left-0 h-[400px] lg:h-auto lg:w-[42%] lg:max-w-[460px] bg-[#ba90ff] rounded-xl">
          <div className="border border-[#ba90ff] rounded bg-[#ba90ff] px-1 py-1 mb-16">
            <video
              src="https://printify.com/pfh/assets/steps/design.mp4"
              autoPlay
              className="w-[300px] h-[400px] sm:w-[500px] sm:h-[500px]  object-cover"
              muted
            >
